...
unsigned long currentTime = millis();  // Глобална променлива
...
//***************************************************
  ...
  delay(10);  // малко закъснение за стабилизация. Работи неизвестно как, но ако го няма се появява бъг 30s след докосване на drawButton_01 !!!
}
