...
#define LED_PIN 25     // Използваме GPI15 за светодиод
...
void setup() {
  ...
  // Тест на светодиода
  // Serial.println("Тест на светодиода...");
  // digitalWrite(LED_PIN, HIGH);
  // delay(1000);
  // digitalWrite(LED_PIN, LOW);
  // delay(1000);
  // Serial.println("Тестът на светодиода завърши.");
}
...
// 22: IO23 (аналогов вход - от изход ОУ1)
